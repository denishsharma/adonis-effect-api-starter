import type { ITaggedException, TaggedException } from '#core/error/tagged_exception'
import type { ITaggedInternalError, TaggedInternalError } from '#core/error/tagged_internal_error'
import type { Schema } from 'effect'
import { EXCEPTION_MARKER, INTERNAL_ERROR_MARKER } from '#core/error/constants/error_marker_constant'
 ...
 */
export function isTaggedInternalError<T extends string, F extends Schema.Struct.Fields | undefined = undefined>(tagOrTaggedInternalErrorClass?: string | ITaggedInternalError<T, F> | undefined) {
 ...
 */
export function isTaggedException<T extends string, F extends Schema.Struct.Fields | undefined = undefined>(tagOrTaggedExceptionClass?: string | ITaggedException<T, F> | undefined) {
